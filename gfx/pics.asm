...
PKMNTrainerHFPic:                 INCBIN "gfx/trainers/PKKMNTrainerHF.2bpp.lz"
PKKMNTrainerHMPic:                INCBIN "gfx/trainers/PKKMNTrainerHM.2bpp.lz"
TraineePic:                  INCBIN "gfx/trainers/trainee.2bpp.lz"
