...
TimePieceIcon::    INCBIN "gfx/items/timepiece.2bpp.lz" ; todo 


SECTION "Key Item Icons 2", ROMX

KurtsMapIcon::	      INCBIN "gfx/items/KurtsMap.2bpp.lz"
MintLeafKIcon:: 	  INCBIN "gfx/items/mint_leaf.2bpp.lz"
TinymushroomKIcon::	  INCBIN "gfx/items/tinymushroom.2bpp.lz"
LemonadeKIcon::	  	  INCBIN "gfx/items/lemonade.2bpp.lz"
BrickPieceKIcon::	  INCBIN "gfx/items/brick_piece.2bpp.lz"
...
PearlKIcon::	   INCBIN "gfx/items/pearl.2bpp.lz"
SurfMailKIcon::	   INCBIN "gfx/items/mail.2bpp.lz"
OldAmberKIcon::	   INCBIN "gfx/items/old_amber.2bpp.lz"
SweetHoneyKIcon::  INCBIN "gfx/items/sweet_honey.2bpp.lz"
