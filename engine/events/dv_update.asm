KimonoDVsUpdate: ; commenting out lines 14 to 17 to see if that makes it work. 
...
;	jr z, .done
; Introduce machine
	ld hl, NewsMachineIntroText2
.continue
	call PrintText
	call YesNoBox
	jr c, .cancel
; Choose a party Pokémon
	ld hl, NewsMachineWhichMonText2
	call PrintText
