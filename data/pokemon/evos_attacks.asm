...
Growlithe_HisuianEvosAttacks:
	...
	db 10, SAFEGUARD ; Odor Sleuth → egg move
	db 12, BATON_PASS ; Helping Hand → new move
	db 17, ROCK_THROW ; Flame Wheel → egg move
	db 19, REVERSAL
	db 21, DOUBLE_KICK ; Fire Fang → egg move
	db 23, TAKE_DOWN
	db 28, FLAME_CHARGE ; Flame Burst → TM move
	...
	db 34, FLAMETHROWER
	db 39, CRUNCH
	db 41, ROCK_SLIDE ; Heat Wave → TM move
	db 43, OUTRAGE
	db 45, PLAY_ROUGH ; Flare Blitz → Let's Go move
	db 49, FLARE_BLITZ
	db 0 ; no more level-up moves
...
Voltorb_HisuianEvosAttacks:  
	...
	db 1, THUNDERSHOCK ; Let's Go move
	db 4, ROLLOUT
	db 6, ABSORB ; Eerie Impulse → event move
	db 9, SPARK
	db 11, SONIC_BOOM
	db 13, SCREECH
	db 16, THUNDER_WAVE ; Charge Beam → TM move
	...
	db 34, EXPLOSION ; Magnet Rise → Explosion
	db 37, THUNDER ; Discharge → TM move
	db 41, ENERGY_BALL ; Explosion → new move
	db 46, GYRO_BALL
	db 48, MIRROR_COAT
	db 0 ; no more level-up moves
...
Xatu_AncestorEvosAttacks: 
	...
	db 20, PAIN_SPLIT ; Ominous Wind → HGSS tutor move
	db 23, CONFUSE_RAY
	db 29, POWER_GEM ; Wish → similar move
	db 35, ROCK_SLIDE
	db 39, ANCIENTPOWER ; Miracle Eye → egg move
	db 43, PSYCHIC_M ; Psycho Shift → egg move
	db 49, FUTURE_SIGHT
	db 53, HEX ; Power Swap + Guard Swap → new move
	db 57, STONE_EDGE ; Me First → HGSS tutor move
	db 0 ; no more level-up moves
...
Qwilfish_HisuianEvosAttacks:
	...
	db 5, DEFENSE_CURL ; Harden → TM move
	db 9, MINIMIZE
	db 13, PIN_MISSILE ; Bubble → similar move
	db 17, ROLLOUT
	db 21, TOXIC_SPIKES
	db 25, PAIN_SPLIT ; Stockpile + Spit Up → HGSS move tutor
	db 29, REVERSAL ; Revenge → Sw/Sh move
...
Sneasel_HisuianEvosAttacks:
	...
	db 8, QUICK_ATTACK
	db 10, FEINT_ATTACK
	db 14, LOW_KICK ; Icy Wind → Ice Shard
	db 20, AGILITY
	db 22, METAL_CLAW
	db 25, HONE_CLAWS
	db 28, POISON_JAB ; Beat Up → egg move
	db 32, SCREECH
	db 35, SLASH
	db 40, SWORDS_DANCE ; Snatch → event move (Moonlight)
	db 44, X_SCISSOR ; Punishment → TM move
	db 47, CLOSE_COMBAT ; Ice Shard → new move
	db 0 ; no more level-up moves
...
Magcargo_AncestorEvosAttacks: 
	...
	db 1, POISON_STING
	db 1, ROLLOUT
	db 1, GYRO_BALL ; Incinerate → new move
	db 25, ACID
	db 27, IRON_TAIL ; Flame Burst → TM move
	db 34, POISON_JAB ; Lava Plume → HGSS tutor move
	db 36, AMNESIA
	db 43, FLASH_CANNON
	db 47, RECOVER
	db 54, TOXIC_SPIKES
...
Corsola_GalarianEvosAttacks:
	...
	db 1, TACKLE
	db 1, DEFENSE_CURL ; Harden → similar move
	db 4, ASTONISH ; Bubble → similar move
	db 8, DISABLE ; Recover → TM move
	db 10, HAZE
	db 13, SAFEGUARD ; Refresh → egg move
	db 17, ANCIENTPOWER
	db 20, ICICLE_SPEAR ; Spike Cannon → egg move
	db 23, CONFUSE_RAY ; Lucky Chant → egg move
	db 27, ENDURE ; Brine → Endure
	db 29, HEX ; Iron Defense → similar move
	db 31, ROCK_BLAST
	db 35, RECOVER ; Endure → Recover
	db 38, CURSE ; Aqua Ring → Sw/Sh move
	db 41, POWER_GEM
	db 45, MIRROR_COAT
	db 47, EARTH_POWER
	db 50, GIGA_DRAIN ; Flail → similar move
	db 0 ; no more level-up moves
...
StantlerEvosAttacks:
	db EVOLVE_MOVE, ZEN_HEADBUTT, WYRDEER
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, LEER
	db 1, ASTONISH
