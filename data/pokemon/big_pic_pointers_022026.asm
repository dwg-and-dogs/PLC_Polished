	...
	dba SunkernFrontpic         ; SUNKERN         ; c7
...
; Alolan Forms
	...
	dba Geodude_alolanFrontpic
	dba Graveler_alolanFrontpic
	dba Golem_alolanFrontpic
	dba Grimer_alolanFrontpic
	dba Muk_alolanFrontpic
	dba Exeggutor_alolanFrontpic

; Galarian Forms
	dba Ponyta_galarianFrontpic
	dba Rapidash_galarianFrontpic
	dba Slowpoke_galarianFrontpic
	dba Slowbro_galarianFrontpic
	dba Slowking_galarianFrontpic
	dba Weezing_galarianFrontpic
	dba Corsola_galarianFrontpic

; Hisuian Forms
	dba Typhlosion_hisuianFrontpic
	dba Samurott_hisuianFrontpic
	dba Decidueye_hisuianFrontpic
	dba Growlithe_hisuianFrontpic
	dba Arcanine_hisuianFrontpic
	dba Voltorb_hisuianFrontpic
	dba Electrode_hisuianFrontpic
	dba Qwilfish_hisuianFrontpic
	dba Sneasel_hisuianFrontpic


; Other Forms
	dba Ursaluna_bloodmoonFrontpic
	dba Noctowl_immortalFrontpic
	dba Feraligatr_ancestorFrontpic
	dba Meganium_ancestorFrontpic
	dba Magcargo_ancestorFrontpic
	dba Xatu_ancestorFrontpic
