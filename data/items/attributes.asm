...
; LEMONADE
	item_attribute 200, 0, 70, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; MOOMOO MILK
...
; SUN STONE
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DUSK STONE
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; DAWN STONE
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; METAL COAT
	item_attribute 30000, HELD_TYPE_BOOST, STEEL, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
...
; KING'S ROCK
	item_attribute 30000, HELD_FLINCH_UP, 10, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS BAND
...
; ARMOR SUIT
	item_attribute 0, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AIR BALLOON
	item_attribute 5000, HELD_AIR_BALLOON, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ASSAULT VEST
...
; DRAGON SCALE
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UP-GRADE
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DUBIOUS DISC
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; RAZOR FANG
	item_attribute 30000, HELD_FLINCH_UP, 10, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAZOR CLAW
	item_attribute 30000, HELD_CRITICAL_UP, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ODD SOUVENIR
	item_attribute 30000, 0, 0, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; NUGGET
