...
; ================
	...
	; party
if DEF(NORMALMODE)
	db 32, DUSCLOPS, NO_ITEM, 60, FAKE_PERFECT_DVS,ABILITY_1 | NAT_NEUTRAL, FEMALE, "Kenophobia@"
	...
	db 32, DUSKNOIR, LEFTOVERS, 60, FAKE_PERFECT_DVS,ABILITY_1 | NAT_NEUTRAL, FEMALE, "Kenophobia@"
		db SHADOW_CLAW, WILL_O_WISP, CURSE, PAIN_SPLIT
...
; ================
	...
	; party
	db 38, LANTURN, SHINY_MASK | ABILITY_1 | NAT_NEUTRAL, FEMALE, "Aluxxa@"
