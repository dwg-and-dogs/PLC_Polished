...
; ================
	...
	; party
	db 31, MANTINE, FOCUS_SASH, FAKE_PERFECT_DVS, "Catalina@"
		db RAIN_DANCE, WATER_PULSE, HURRICANE, ROOST
	db 33, NOCTOWL, SCOPE_LENS, DVS_HP_FLYING,"Hawker@"
		db AERIAL_ACE, MUD_SLAP, ROOST, HURRICANE
	db 32, GLIGAR, NO_ITEM, FAKE_PERFECT_DVS,"Stratofor@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 16, YANMA, NO_ITEM, FAKE_PERFECT_DVS, "Sonic@"
		db SONIC_BOOM, CONFUSE_RAY, GUST, U_TURN
	db 16, PARASECT, NO_ITEM, DVS_HP_BUG, "Mickey@" ; GREEN 
		db SLEEP_POWDER, SLASH, ABSORB, GROWTH
	db 20, SLUGMA, NO_ITEM, FAKE_PERFECT_DVS, "Helix@"
		db EMBER, ROCK_THROW, AMNESIA, RECOVER
	db 18, SCYTHER, SITRUS_BERRY,DVS_HP_BUG,  "Manny@"
...
; ================================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 27, CLEFAIRY, SITRUS_BERRY, FAKE_PERFECT_DVS, "Resonator@"
		db ATTRACT, HYPER_VOICE, METRONOME, SING
	db 28, NIDOQUEEN, CHESTO_BERRY, DVS_HP_POISON, "BriarRose@"
		db ATTRACT, REST, BODY_SLAM, BULLDOZE
	db 29, MILTANK, LUM_BERRY, DVS_HP_PSYCHIC, "UddrDefeat@"
...
; ================
	...
	db 40, HAUNTER, EVIOLITE,  FAKE_PERFECT_DVS,"HarryPoltr@"
		db SUCKER_PUNCH, ICE_PUNCH, SHADOW_CLAW, CURSE
	db 43, MISMAGIUS, SITRUS_BERRY,  FAKE_PERFECT_DVS,"Melisandre@"
		db ATTRACT, NASTY_PLOT, MOONBLAST, SHADOW_BALL
	db 44, PARASECT, SILVERPOWDER,  FAKE_PERFECT_DVS,"BeetleJuce@"
		db SPORE, X_SCISSOR, GIGA_DRAIN, NIGHT_SHADE
	db 44, WYRDEER, BLACK_BELT, FAKE_PERFECT_DVS, "NecroDancr@"
		db ZEN_HEADBUTT, DOUBLE_EDGE, AGILITY, DOUBLE_KICK	
	db 46, GENGAR, WIDE_LENS,  DVS_HP_DARK,"Jung-Gar@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 43, GLALIE, FOCUS_SASH, FAKE_PERFECT_DVS, "Aperifrizo@"
		db SPIKES, EXPLOSION, HAIL, ICY_WIND
	db 43, LAPRAS, NO_ITEM,  DVS_HP_PSYCHIC,"Raspberry@"
		db CALM_MIND, SURF, THUNDERBOLT, ICE_BEAM
	db 45, SNEASEL, NEVERMELTICE,  FAKE_PERFECT_DVS,"SneaSalt@"
		db SWORDS_DANCE, ICICLE_CRASH, NIGHT_SLASH, ICE_SHARD
	db 45, MAMOSWINE, SOFT_SAND,  DVS_HP_ROCK,"Baconator@" ; also used at ecruteak gym 
...
; ================
	...
	db 48, GYARADOS, CHOICE_BAND, FAKE_PERFECT_DVS, "AdaGyros@"
	...
	db 46, TAUROS, CHOICE_BAND, FAKE_PERFECT_DVS, "RoastU@"
		db EARTHQUAKE, DOUBLE_EDGE, FLAME_CHARGE, NO_MOVE
...
; ================
	...
	; KURT12 ; whispering way and top of clasts cradle 
	db "Kurt@"
	db TRAINERTYPE_NORMAL
	; party
	db 42, NIDOKING
	...
	; party
	db 50, BLISSEY, NO_ITEM, 0
		db SEISMIC_TOSS, NO_MOVE, NO_MOVE, NO_MOVE
	db 50, LAPRAS, NO_ITEM, 0
		db BUBBLE_BEAM, AURORA_BEAM, NO_MOVE, NO_MOVE
	db 50, GYARADOS, NO_ITEM, 0
		db BITE, WATER_PULSE, NO_MOVE, NO_MOVE
	db 50, ARCANINE, NO_ITEM, 0
		db EMBER, QUICK_ATTACK, NO_MOVE, NO_MOVE
	db 50, EXEGGUTOR, NO_ITEM, 0
		db MEGA_DRAIN, CONFUSION, NO_MOVE, NO_MOVE
	db 50, RHYPERIOR, NO_ITEM, 0
		db BULLDOZE, ROCK_THROW, NO_MOVE, NO_MOVE
	db -1 ; end
...
; ================
	...
	db 60, LUGIA, NO_ITEM, DVS_HP_DARK, "Galegift@"
		db RECOVER, AEROBLAST, WHIRLPOOL, ANCIENTPOWER
	db 55, NIDOKING, POISON_BARB, FAKE_PERFECT_DVS, "Seismark@"
		db SLUDGE_BOMB, EARTHQUAKE, POISON_JAB, THUNDER		
	db 58, SKARMORY, LEFTOVERS, FAKE_PERFECT_DVS, "Lyrica@"
		db DRILL_PECK, IRON_HEAD, CURSE, ROOST
	db 56, DRAGONITE, LIFE_ORB, DVS_HP_FLYING, "Lazuli@"
		db OUTRAGE, WATERFALL, FLY, ROOST
	db 58, SCIZOR, METAL_COAT, DVS_HP_BUG, "Ferrux@"
		db BULLET_PUNCH, SWORDS_DANCE, X_SCISSOR, IRON_HEAD
	db 60, HO_OH, SITRUS_BERRY, DVS_HP_FIRE, "Eversol@"
		db RECOVER, SACRED_FIRE, BRAVE_BIRD, ANCIENTPOWER
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 18, MARILL, NO_ITEM, DVS_HP_PSYCHIC, "Efferve@"
		db BUBBLE_BEAM, ROLLOUT, CHARM, NO_MOVE
	db 19, TOGETIC, NO_ITEM, DVS_HP_FLYING, "Clutch@"
		db EXTRASENSORY, DRAIN_KISS, METRONOME, NO_MOVE
	db 20, SNUBBULL, NO_ITEM, FAKE_PERFECT_DVS, "Rusty@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 48, AZUMARILL, NO_ITEM, DVS_HP_PSYCHIC, "Efferve@"
		db SURF, MOONBLAST, AQUA_JET, ROLLOUT
...
; ================
	...
	db 30, GENGAR, LUM_BERRY, FAKE_PERFECT_DVS,ABILITY_1 | NAT_NEUTRAL, FEMALE, "Te No Me@"
		db SHADOW_CLAW, DESTINY_BOND, MEAN_LOOK, SUCKER_PUNCH
	db 33, MISDREAVUS, NO_ITEM, DVS_HP_ELECTRIC,ABILITY_1 | NAT_NEUTRAL, FEMALE, "Sabrina@"
		db THUNDER_WAVE, PSYCHIC_M, SHADOW_BALL, HEX
	db 33, STANTLER, ZOOM_LENS,FAKE_PERFECT_DVS,ABILITY_1 | NAT_NEUTRAL, FEMALE, "Pallbearer@"
		db HI_JUMP_KICK, HYPNOSIS, STOMP, U_TURN
	db 36, TYPHLOSION, SPELL_TAG, FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, FEMALE | HISUIAN_FORM,  "Charon@"
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 22, GEODUDE, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM
	db 25, GRAVELER, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM
	db 25, GOLEM, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM
	; party
	db 26, QUAGSIRE, SITRUS_BERRY
	db 26, RAICHU, SITRUS_BERRY
	db -1 ; end
...
; ================
	...
	db 18, LEDIAN
		db MACH_PUNCH, SUPERSONIC, BUG_BITE, AGILITY
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 36, YANMEGA, ABILITY_1 | NAT_NEUTRAL, MALE 
	db 40, MEGANIUM, ABILITY_1 | NAT_NEUTRAL, MALE | OTHER_FORM
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 15, UNOWN, NO_ITEM, FAKE_PERFECT_DVS, "Alphred@"
		db HIDDEN_POWER, NO_MOVE, NO_MOVE, NO_MOVE	
	db 20, DRATINI, NO_ITEM, FAKE_PERFECT_DVS, "Hugs@"
		db WRAP, DRAGON_RAGE, NO_MOVE, NO_MOVE	
	db 25, HITMONLEE, NO_ITEM, DVS_HP_GRASS, "Brocco@"
		db DOUBLE_KICK, TACKLE, NO_MOVE, NO_MOVE	
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 28, QUILAVA, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 30, MAGMAR, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 32, ARCANINE, ABILITY_1 | NAT_NEUTRAL, FEMALE | HISUIAN_FORM 
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 28, QWILFISH,  ABILITY_1 | NAT_NEUTRAL, FEMALE | HISUIAN_FORM 
	db 30, JYNX, ABILITY_1 | NAT_NEUTRAL, FEMALE 
	db 32, FERALIGATR, ABILITY_1 | NAT_NEUTRAL, FEMALE 
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 28, LUXIO, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 30, ELECTABUZZ, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db 32, ELECTRODE, ABILITY_1 | NAT_NEUTRAL, FEMALE | HISUIAN_FORM 
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 44, BRAVIARY, ABILITY_1 | NAT_NEUTRAL, MALE
	db 45, DRIFBLIM, ABILITY_1 | NAT_NEUTRAL, MALE 
	db 45, AMPHAROS	, ABILITY_1 | NAT_NEUTRAL, MALE 
	db 47, ELECTRODE, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 13, ONIX, ABILITY_1 | NAT_NEUTRAL, MALE
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 25, ONIX, ABILITY_1 | NAT_NEUTRAL, FEMALE
...
; ================
	...
	db 52, PARASECT, ABILITY_1 | NAT_NEUTRAL, FEMALE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_PERSONALITY
	; party
	db 40, NINETALES, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM
	db 40, PILOSWINE, ABILITY_1 | NAT_NEUTRAL, MALE
	db -1 ; end
...
;	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
;	; party
;	db 25, QUILAVA, NO_ITEM, DVS_HP_BUG, "Bug@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE	
;	db 25, GENGAR, NO_ITEM, DVS_HP_DARK, "Dark@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, LUXRAY, NO_ITEM, DVS_HP_DRAGON, "Dragon@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, CLEFABLE, NO_ITEM, DVS_HP_ELECTRIC, "Electric@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, RAMPARDOS, NO_ITEM, DVS_HP_FIGHTING, "Fighting@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, DRIFBLIM, NO_ITEM, DVS_HP_FIRE, "Fire@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db -1 ; end
...
;	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
;	; party
;	db 25, TYRANITAR, NO_ITEM, DVS_HP_PSYCHIC, "Psychic@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE	
;	db 25, CROBAT, NO_ITEM, DVS_HP_GHOST, "Ghost@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, GASTLY, NO_ITEM, DVS_HP_GRASS, "Grass@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, TOXICROAK, NO_ITEM, DVS_HP_GROUND, "Ground@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, DECIDUEYE, NO_ITEM, DVS_HP_ICE, "Ice@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db 25, YANMA, NO_ITEM, DVS_HP_POISON, "Poison@"
;		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
;	db -1 ; end
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 25, DRAGONITE, NO_ITEM, DVS_HP_FLYING, "Flying@"
		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE	
	db 25, AMPHAROS, NO_ITEM, DVS_HP_ROCK, "Rock@"
		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
	db 25, BRONZONG, NO_ITEM, DVS_HP_WATER, "Water@"
		db SPIKES, NO_MOVE, NO_MOVE, NO_MOVE		
	db -1 ; end
...
; ================
	...
	db "Jaska@"
	db TRAINERTYPE_PERSONALITY
	db 40, RAICHU, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM
	db 43, RAPIDASH, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM	
	db 43, MUK, ABILITY_1 | NAT_NEUTRAL, MALE | ALOLAN_FORM	
	db -1 ; end
...
; ================
	...
	db "Gareth@"
	db TRAINERTYPE_PERSONALITY
	db 40, RAPIDASH, ABILITY_1 | NAT_NEUTRAL, MALE | GALARIAN_FORM
	db 43, SLOWBRO, ABILITY_1 | NAT_NEUTRAL, MALE | GALARIAN_FORM	
	db 43, WEEZING, ABILITY_1 | NAT_NEUTRAL, MALE | GALARIAN_FORM	
	db -1 ; end
...
; ================
	...
	db "Rosie@"
	db TRAINERTYPE_PERSONALITY
	db 43, SLOWKING, ABILITY_1 | NAT_NEUTRAL, MALE | GALARIAN_FORM	
	db 43, CORSOLA, ABILITY_1 | NAT_NEUTRAL, MALE | GALARIAN_FORM	
	db -1 ; end
...
; ================
	...
	db 8, PONYTA, ABILITY_1 | NAT_NEUTRAL, FEMALE | GALARIAN_FORM	
	db -1 ; end
...
; ================
	...
	db "Lenie@"
	db TRAINERTYPE_PERSONALITY
	db 7, VULPIX, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM	
	db 8, GRIMER, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM	
	db -1 ; end
...
; ================
	...
	db "Flo@"
	db TRAINERTYPE_PERSONALITY
	db 20, RAICHU, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM	
	db 22, EXEGGUTOR, ABILITY_1 | NAT_NEUTRAL, FEMALE | ALOLAN_FORM	
	db -1 ; end
...
; ================
	...
	db "Sophie@"
	db TRAINERTYPE_PERSONALITY
	db 20, SLOWKING, ABILITY_1 | NAT_NEUTRAL, FEMALE | GALARIAN_FORM	
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 25, MAGNETON, AIR_BALLOON, ABIL_MAGNETON_ANALYTIC | NAT_NEUTRAL, MALE
		db THUNDERSHOCK, TRI_ATTACK, NO_MOVE, NO_MOVE
	db 25, MAGCARGO, AIR_BALLOON, ABIL_MAGCARGO_WEAK_ARMOR | NAT_NEUTRAL, MALE
...
; ================
	...
	; party
	db 30, MAGNETON, AIR_BALLOON, 40, "Neody@"
	db 30, MAGCARGO, AIR_BALLOON, 40, "Molly@"
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 26, SLOWKING, NO_ITEM
		db WHIRLPOOL, NO_MOVE, NO_MOVE, NO_MOVE
	db 28, KADABRA, NO_ITEM
		db WHIRLPOOL, NO_MOVE, NO_MOVE, NO_MOVE
	db 30, MISDREAVUS, NO_ITEM
		db WHIRLPOOL, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 40, GLOOM, POISON_BARB, ABILITY_1 | NAT_NEUTRAL, FEMALE 
...
; ================
	...
	db 30, QUILAVA, CHARCOAL,DVS_HP_BUG,  "Everbright@"
		db FLAME_CHARGE, DEFENSE_CURL, DIG, ROLLOUT
	db 30, DARTRIX, MIRACLE_SEED, DVS_HP_GROUND, "Argus@"
		db ROOST, ENERGY_BALL, WING_ATTACK, RAZOR_LEAF
	db 30, DEWOTT, MYSTIC_WATER, DVS_HP_DARK, "Bulwark@"
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY |  TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 45, BRONZONG, NO_ITEM, DVS_HP_WATER, ABILITY_1 | NAT_NEUTRAL, MALE, "Overtone@"
		db ZEN_HEADBUTT, THUNDER, MIRROR_COAT, RAIN_DANCE
	db 48, ELECTRODE, LEFTOVERS,FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM, "EggStatic@"
		db LEECH_SEED, THUNDER, GIGA_DRAIN, VOLT_SWITCH
	db 49, TYPHLOSION, NO_ITEM,DVS_HP_BUG, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM,   "Everbright@"
		db SHADOW_BALL, FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH
	db 49, DECIDUEYE, NO_ITEM,DVS_HP_GROUND, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM, "Argus@"
		db AURA_SPHERE, ENERGY_BALL, AIR_SLASH, CLOSE_COMBAT
	db 49, SAMUROTT, NO_ITEM, DVS_HP_DARK, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM,  "Bulwark@"
...
; ================
	...
	db 20, MAGMAR, NO_ITEM,FAKE_PERFECT_DVS, "Culverin@"
		db SUNNY_DAY, STRENGTH, FLAME_CHARGE, SMOKESCREEN
	...
	db 24, FLAREON, NO_ITEM,DVS_HP_FIRE, "Kotei@"
	...
	db 51, NINETALES, FOCUS_SASH, FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, MALE, "NineLives@"
		db HYPNOSIS, FLAMETHROWER, PSYCHIC_M, WILL_O_WISP
	db 54, MAGMORTAR, AIR_BALLOON,FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, MALE,  "Culverin@"
		db SUNNY_DAY, THUNDERBOLT, SOLAR_BEAM, FIRE_BLAST
	db 55, SUNFLORA, SITRUS_BERRY, DVS_HP_BUG, ABILITY_1 | NAT_NEUTRAL, MALE, "Helia@"
		db SUNNY_DAY, GROWTH, SOLAR_BEAM, FLAMETHROWER
	db 55, OCTILLERY, SCOPE_LENS, FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, MALE, "Levi@"
		db FLAMETHROWER, OCTAZOOKA, HYPER_BEAM, ROCK_BLAST
	db 53, ARCANINE, SITRUS_BERRY, FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM, "Dauntless@"
		db BODY_SLAM, EXTREMESPEED, FLARE_BLITZ, ROCK_SLIDE
	db 55, FLAREON, LEFTOVERS, DVS_HP_FIRE, ABILITY_1 | NAT_NEUTRAL, MALE, "Kotei@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 57, MAGNEZONE, AIR_BALLOON, FAKE_PERFECT_DVS, "Yogauss@" ; union , gauss 
...
; ================
	...
	db 38, TENTACRUEL, NO_ITEM, DVS_HP_ROCK, "Snare@"
		db WHIRLPOOL, POISON_JAB, RAPID_SPIN, RECOVER
...
; ================
	...
	db 48, TENTACRUEL, NO_ITEM, DVS_HP_ROCK,  "Snare@"
		db WHIRLPOOL, SURF, POISON_JAB, RECOVER
...
; ================
	...
	db 42, AVALUGG, FOCUS_SASH,FAKE_PERFECT_DVS, "Aconcagua@" 
		db ROCK_SLIDE, EARTHQUAKE, AVALANCHE, MIRROR_COAT
	db 44, BRAVIARY, NO_ITEM,DVS_HP_PSYCHIC,  "Denali@" ; wind spirit
