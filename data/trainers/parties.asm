...
if DEF(NORMALMODE)
	; party
	db 31, MANTINE, NO_ITEM, FAKE_PERFECT_DVS, "Catalina@"
		db RAIN_DANCE, WATER_PULSE, WING_ATTACK, ROOST
	db 32, NOCTOWL, NO_ITEM, DVS_HP_FLYING,"Hawker@"
...
if DEF(NORMALMODE)
	...
	db 48, GENGAR, NO_ITEM,  DVS_HP_DARK,"Jung-Gar@"
...
if DEF(NORMALMODE)
	...
	db 41, TOXICROAK, NO_ITEM,  FAKE_PERFECT_DVS,"Karana@"
...
; ================
	...
	; party
if DEF(NORMALMODE)
	db 43, GLALIE, NO_ITEM, FAKE_PERFECT_DVS, "Aperifrizo@"
...
; ================
	...
	; party
if DEF(NORMALMODE)
	db 46, DRAGONAIR, NO_MOVE, DVS_HP_WATER, "GordianRa@"
		db WRAP, FIRE_BLAST, REST, THUNDER_WAVE
	db 46, GYARADOS, NO_MOVE, FAKE_PERFECT_DVS, "AdaGyros@"
		db EARTHQUAKE, STRENGTH, WATERFALL, FLY
	db 48, KINGDRA, NO_MOVE, DVS_HP_DRAGON, "DarkGin@"
	...
	db 48, DRAGONAIR, NO_MOVE,  DVS_HP_ICE,"OrganRaid@"
...
; ================
	...
	; party
if DEF(NORMALMODE)
	db 32, DUSCLOPS, NO_ITEM, 60, FAKE_PERFECT_DVS,ABILITY_1 | NAT_NEUTRAL, FEMALE, "Yamaduta@"
...
if DEF(NORMALMODE)
	...
	db 48, ELECTRODE, NO_ITEM,FAKE_PERFECT_DVS, ABILITY_1 | NAT_NEUTRAL, MALE | HISUIAN_FORM, "EggStatic@"
	...
	; party
	db 45, BRONZONG, METAL_COAT, DVS_HP_WATER, ABILITY_1 | NAT_NEUTRAL, MALE, "Overtone@"
...
if DEF(NORMALMODE)
	...
	db 22, OCTILLERY, NO_ITEM, FAKE_PERFECT_DVS,"Levi@"
		db EMBER, BUBBLE_BEAM, NO_MOVE, NO_MOVE
	db 24, FLAREON, NO_ITEM,DVS_HP_FIRE, "Kotei@"
		db SUNNY_DAY, FLAME_CHARGE, ROCK_SMASH, NO_MOVE
else
	; party
	db 20, MAGMAR, NO_ITEM,FAKE_PERFECT_DVS, "Culverin@"
...
if DEF(NORMALMODE)
	...
	db 55, FLAREON, NO_ITEM, DVS_HP_FIRE, ABILITY_1 | NAT_NEUTRAL, MALE, "Kotei@"
...
; ================
	...
	; party
if DEF(NORMALMODE)
	db 25, PINECO, NO_ITEM,  FAKE_PERFECT_DVS, "KiloJaal@" ; net or trap 
		db SPIKES, EXPLOSION, U_TURN, NO_MOVE
	db 25, LUXIO, NO_ITEM,  FAKE_PERFECT_DVS, "Kalamp@" ; darkness, amp 
...
endc
	...
	; party
if DEF(NORMALMODE)
	db 48, FORRETRESS, NO_ITEM, FAKE_PERFECT_DVS, "KiloJaal@"
		db SPIKES, EXPLOSION, U_TURN, NO_MOVE		
...
if DEF(NORMALMODE)
	...
	db 56, HONCHKROW, NO_ITEM, FAKE_PERFECT_DVS, "Kalraja@"
		db DRILL_PECK, DARK_PULSE, SUCKER_PUNCH, HAZE
	db 57, LUXRAY, NO_ITEM, FAKE_PERFECT_DVS, "Kalamp@"
