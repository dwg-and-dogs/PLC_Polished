...
; ================
	...
	db 33, GLIGAR, SOFT_SAND, FAKE_PERFECT_DVS,"Stratofor@"
		db PROTECT, AERIAL_ACE, BULLDOZE, TOXIC
	db 30, MURKROW, FOCUS_SASH, DVS_HP_GHOST,"TODO@" ; todo 
		db PERISH_SONG, PROTECT, FLY, CONFUSE_RAY
	db 32, XATU, SOFT_SAND, DVS_HP_PSYCHIC,"TODO@" ; todo 
		db ROAR, CALM_MIND, PSYBEAM, RAIN_DANCE
	db 30, JUMPLUFF, SCOPE_LENS, DVS_HP_GRASS,"TODO@" ; todo 
...
; ================================
	...
	db 29, FURRET, KINGS_ROCK, FAKE_PERFECT_DVS, "Ursula@" ;  
		db AGILITY, HEADBUTT, DIG, ATTRACT
	db 29, SNORLAX, LEFTOVERS, FAKE_PERFECT_DVS, "Scorn@" ;  
		db RAGE, ROAR, ATTRACT, NO_MOVE
	db 28, DITTO, CHOICE_SCARF, FAKE_PERFECT_DVS, "Refract@" ;  
...
; ================
	...
	db 49, GENGAR, WIDE_LENS,  DVS_HP_DARK,"Jung-Gar@"
		db HEX, HYPNOSIS, SHADOW_BALL, DREAM_EATER
	db 49, GENGAR, WIDE_LENS,  DVS_HP_DARK,"Jung-Gar@"
		db HEX, HYPNOSIS, SHADOW_BALL, DREAM_EATER ; TODO 
	db -1 ; end
...
; ================
	...
	db 41, TOXICROAK, POISON_BARB,  FAKE_PERFECT_DVS,"Donatello@"
		db SLASH, SWORDS_DANCE, POISON_JAB, SUCKER_PUNCH
	db 43, POLIWRATH, MYSTIC_WATER,  DVS_HP_GRASS,"TadSwole@" ; todo 
		db SURF, HYPNOSIS, DYNAMICPUNCH, BODY_SLAM
	db 43, POLIWRATH, MYSTIC_WATER,  DVS_HP_GRASS,"TadSwole@" ; todo 
		db SURF, HYPNOSIS, DYNAMICPUNCH, BODY_SLAM
	db 43, POLIWRATH, MYSTIC_WATER,  DVS_HP_GRASS,"TadSwole@" ; todo 
...
; ================
	...
	db 48, RHYPERIOR, CHOICE_SCARF, FAKE_PERFECT_DVS, "Wrecker@"
		db ROCK_SLIDE, EARTHQUAKE, MEGAHORN, BODY_SLAM
	db 48, RHYPERIOR, CHOICE_SCARF, FAKE_PERFECT_DVS, "Wrecker@"
		db ROCK_SLIDE, EARTHQUAKE, MEGAHORN, BODY_SLAM ; todo 
	db 48, RHYPERIOR, CHOICE_SCARF, FAKE_PERFECT_DVS, "Wrecker@"
		db ROCK_SLIDE, EARTHQUAKE, MEGAHORN, BODY_SLAM ; todo 
	db -1 ; end
...
; ================
	...
	db 50, DRAGONAIR, EVIOLITE,  DVS_HP_ICE,"OrganRaid@"
		db DRAGON_DANCE, REST, SLEEP_TALK, DRAGON_CLAW
	db 50, DRAGONAIR, EVIOLITE,  DVS_HP_ICE,"OrganRaid@"
		db DRAGON_DANCE, REST, SLEEP_TALK, DRAGON_CLAW; todo 
	db -1 ; end
...
; ================
	...
	db "Silas@"
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party	db 48, LEDIAN, NO_ITEM,  DVS_HP_BUG, "Tinnire@"
		db AIR_SLASH, CLOSE_COMBAT, X_SCISSOR, BUG_BITE
	db 46, SLOWBRO, NO_ITEM, FAKE_PERFECT_DVS, "Speleo@"
