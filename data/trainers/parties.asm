...
; ================
	...
	db 33, GLIGAR, SOFT_SAND, FAKE_PERFECT_DVS,"Stratofor@"
		db PROTECT, AERIAL_ACE, BULLDOZE, TOXIC
	db 33, GLIGAR, SOFT_SAND, FAKE_PERFECT_DVS,"Stratofor@" ; todo 
		db PROTECT, AERIAL_ACE, BULLDOZE, TOXIC
	db 33, GLIGAR, SOFT_SAND, FAKE_PERFECT_DVS,"Stratofor@" ; todo 
		db PROTECT, AERIAL_ACE, BULLDOZE, TOXIC
	db 33, GLIGAR, SOFT_SAND, FAKE_PERFECT_DVS,"Stratofor@" ; todo 
...
; ================
	...
	db 18, SCYTHER, SITRUS_BERRY,DVS_HP_BUG,  "Manny@"
		db QUICK_ATTACK, SWORDS_DANCE, PURSUIT, U_TURN
	db 18, SCYTHER, SITRUS_BERRY,DVS_HP_BUG,  "Manny@" ; todo 
		db QUICK_ATTACK, SWORDS_DANCE, PURSUIT, U_TURN
	db 18, SCYTHER, SITRUS_BERRY,DVS_HP_BUG,  "Manny@" ; todo 
		db QUICK_ATTACK, SWORDS_DANCE, PURSUIT, U_TURN
	db -1 ; end
...
; ================================
	...
	db 29, MILTANK, LUM_BERRY, DVS_HP_PSYCHIC, "UddrDefeat@"
		db ROLLOUT, DEFENSE_CURL, FRESH_SNACK, BODY_SLAM
	db 29, MILTANK, LUM_BERRY, DVS_HP_PSYCHIC, "UddrDefeat@" ; TODO 
		db ROLLOUT, DEFENSE_CURL, FRESH_SNACK, BODY_SLAM
	db 29, MILTANK, LUM_BERRY, DVS_HP_PSYCHIC, "UddrDefeat@" ; TODO 
		db ROLLOUT, DEFENSE_CURL, FRESH_SNACK, BODY_SLAM
	db 29, MILTANK, LUM_BERRY, DVS_HP_PSYCHIC, "UddrDefeat@" ; TODO 
...
Rival1Group: ; this is a job for claude 
; ================================
; ================
