...
; RuinsOfAlphKabutoWordRoom
	...
	def_grass_wildmons MOUNT_MORTAR_1F_OUTSIDE ; NOT ACCESSIBLE 
	db 4 percent, 4 percent, 4 percent ; encounter rates: morn/day/nite
	; morn
	wildmon 41, WEEZING
	wildmon 42, MAGCARGO
	...
	wildmon 20, GEODUDE, ALOLAN_FORM
	wildmon 20, GEODUDE, ALOLAN_FORM
	wildmon 20, GIBLE
	; day
	wildmon 21, VOLTORB
