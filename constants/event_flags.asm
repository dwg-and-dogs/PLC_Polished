...
; Johto Gym Leader TM gifts
	...
	const EVENT_ECRUTEAK_UNOWN 
	const EVENT_DRAGON_PULSE
; HMs
	const EVENT_GOT_HM01_CUT
	const EVENT_FACILITY_CLERK
...
; Kanto hidden items
	...
	const EVENT_BEAT_HISUI_FEMALE_ESTHER
...
; More Johto story events
	...
	const EVENT_LANDING_TIME_TRAVELED; USED TO BE A CONST_SKIP 
	...
	const EVENT_KC4_23
	const EVENT_KC4_33
	const EVENT_OPENED_CAVERN
	const EVENT_ROOF_MEJIMI
	const EVENT_ROOF_KURT
	const EVENT_ROOF_ADRINNA
...
; Medium
	...
	const EVENT_BEAT_HISUI_FEMALE_GRACE
...
; Lady
	const EVENT_BEAT_HISUI_FEMALE_DARLA
	const EVENT_BEAT_HISUI_FEMALE_LORENA
; Breeder
...
; Kanto itemballs
	...
	const EVENT_KIMONO_CABIN_2_LARVITAR_MOVED_1;
	const EVENT_KIMONO_CABIN_2_LARVITAR_MOVED_2;
	const EVENT_KIMONO_CABIN_2_LARVITAR_MOVED_3;
	const EVENT_KIMONO_CABIN_2_LARVITAR_MOVED_4;
	const EVENT_GOT_GEODES;
	const EVENT_SPOOKED_HEDGEHOG;
	const EVENT_BATTLED_CABIN_LARVITAR;
	const EVENT_GAULDENROD_3F_BOULDER;
	const EVENT_GAULDENROD_3F_CLEFAIRY;
	const EVENT_KIMONO_CABIN_3_BOULDER_1;
	const EVENT_KIMONO_CABIN_3_BOULDER_2;
	const EVENT_KIMONO_CABIN_3_BOULDER_3;
	const EVENT_KIMONO_CABIN_3_BOULDER_4;
	const EVENT_KIMONO_CABIN_3_BOULDER_5;
	const EVENT_RADIO_TOWER_KURT2;
	const EVENT_BLUE_TIN_TOWER;
	...
	const EVENT_ROOF_CELEBI 
	const EVENT_KIMONO_CABIN_5_SWITCH_1
	const EVENT_KIMONO_CABIN_5_SWITCH_2
	const EVENT_KIMONO_CABIN_5_SWITCH_3
	const EVENT_KIMONO_CABIN_5_SWITCH_4
	const EVENT_KC4_20
	const EVENT_KC4_10
; Kanto people
	...
	const EVENT_SET_DVS_2
	const EVENT_SET_DVS_3
	const EVENT_SET_DVS_4
	const EVENT_SET_DVS_5
	const EVENT_SET_DVS_6
	const EVENT_NEXUS_SWITCH_5
	const EVENT_NEXUS_SWITCH_4
	const EVENT_NEXUS_SWITCH_3
	const EVENT_NEXUS_SWITCH_2
	const EVENT_NEXUS_SWITCH_1
	const EVENT_NEXUS_WATERFALL_1
	const EVENT_NEXUS_WATERFALL_2
	const EVENT_NEXUS_WATERFALL_3
	const EVENT_NEXUS_WATERFALL_4
	const EVENT_GOT_MACHINE_PART ; new
	const EVENT_BEAT_MEJIMI
	const EVENT_EXTENT_TREE
	const EVENT_PRYCE_REACTED
	const EVENT_CRADLE_CUTSCENE_ADRINNA
	const EVENT_CRADLE_CUTSCENE_KURT
	const EVENT_KAJO_MINSIR
	const EVENT_GAVE_TINYMUSHROOM
	const EVENT_TELEPORT_GUY
	const EVENT_TRADED_RAGECANDYBAR
	const EVENT_GOT_PEARL_OLIVINE
	const EVENT_GOT_OLD_AMBER
	const EVENT_GOT_SWEET_HONEY
	const EVENT_GOT_SURF_MAIL
	const EVENT_CAPITAL_SKIRMISHER
	const EVENT_SKIRMISH_STARTED
	const EVENT_TAPESTRY_BRONZONG
	const EVENT_KIMONOS_AT_TAPESTRY
	const EVENT_KURT_CALM_COAST
	const EVENT_VIOLET_TRADER_SAW_SLOWPOKETAIL
	const EVENT_HALL_OF_FAME_POKEMON_1
	const EVENT_HALL_OF_FAME_POKEMON_2
	const EVENT_HALL_OF_FAME_POKEMON_3
	const EVENT_HALL_OF_FAME_POKEMON_4
	const EVENT_HALL_OF_FAME_POKEMON_5
	const EVENT_HALL_OF_FAME_POKEMON_6
	const EVENT_AZALEA_KIMONO_GIRL
	const EVENT_TAMMY_ANARRES_TOWER
	const EVENT_KURT_OLIVINE_POKECENTER
	const EVENT_STADIUM_BOX_KURT
	const EVENT_TINDER_GARDEN_3_TREE
	const EVENT_NEXUS_LUGIA 
	const EVENT_CC_HEATRAN_2
	const EVENT_GENTLEMAN_GOT_MAIL
	const EVENT_TAPESTRY_SCENE
	const EVENT_GOT_GUYS_NUGGET
	const EVENT_AZALEA_BLACKBELT_POSTGAME
	const EVENT_GOT_GIBLE_EGG
	const EVENT_GOT_EGG_FROM_SCIENTIST
	const EVENT_BEAT_SIGHTSEERF_FLO
	const EVENT_BEAT_SIGHTSEERF_SOPHIE 
	const EVENT_BEAT_MARIO
	const EVENT_BEAT_SCIENTIST_ARI
	const EVENT_GOT_CHARM_FROM_CYNTHIA
	const EVENT_FOUGHT_XATU_VARIANT
	const EVENT_FOUGHT_MAGCARGO_VARIANT
	const EVENT_FOUGHT_MEGANIUM_VARIANT
	const EVENT_FOUGHT_FERALIGATR_VARIANT
	const EVENT_LAIR_HERBBALL 
	const EVENT_FACILITY_SILVER_TROPHY
	const EVENT_FACILITY_BEAT_URSULA
	const EVENT_FACILITY_BEAT_SILAS
	const EVENT_FACILITY_BEAT_BETH
	const EVENT_FACILITY_BEAT_SANDRA
	const EVENT_FACILITY_BEAT_SYBIL
	const EVENT_FACILITY_BEAT_TYSON
	const EVENT_FACILITY_BEAT_NOMADF
	const EVENT_FACILITY_BEAT_BARBEAU
	const EVENT_FACILITY_BEAT_PETRA
	const EVENT_FACILITY_BEAT_AMOS
	const EVENT_FACILITY_BEAT_PIPER
	const EVENT_REACHED_CREDITS_ONCE
	const EVENT_TROPHY_MON_2  
; Orange itemball
...
; New to Crystal
	const EVENT_LAKE_URSALUNA_POSTGAME 
	const EVENT_KURTS_HOUSE_GRANDDAUGHTER_2
	const EVENT_STADIUM_HEALED 
	const EVENT_BEAT_FIRST_FACILITY_TRAINER
	const EVENT_BEAT_SECOND_FACILITY_TRAINER
	const EVENT_BATTLE_TOWER_BATTLE_ROOM_YOUNGSTER
	const EVENT_BEAT_THIRD_FACILITY_TRAINER
	...
	const EVENT_FACILITY_BUG_MANIAC
	const EVENT_FACILITY_AROMA_LADY
	const EVENT_FACILITY_SAGE
	const EVENT_FACILITY_NOMADF
	const EVENT_FACILITY_NINJA
	const EVENT_FACILITY_BRIGADER
	const EVENT_FACILITY_SILAS
	const EVENT_FACILITY_SANDRA
	const EVENT_FACILITY_SYBIL
	const EVENT_FACILITY_REMY
	const EVENT_FACILITY_AMOS
	const EVENT_FACILITY_KURT
	const EVENT_FACILITY_VESPER
	...
	const EVENT_ECRUTEAK_CITY_GRAMPS ; needed 
	...
	const EVENT_SAW_SUICUNE_AT_CIANWOOD_CITY ; needed 
	const EVENT_EUSINE_IN_BURNED_TOWER ; needed 
	const EVENT_ECRUTEAK_GYM_GRAMPS ; needed 
	const EVENT_TROPHY_MON
	const EVENT_FACILITY_GOLD_TROPHY
	const EVENT_FOUGHT_ALAKAZAM_VARIANT
	const EVENT_FOUGHT_LEDIAN_VARIANT 
	const EVENT_TIN_TOWER_1F_WISE_TRIO_2
	const EVENT_TIN_TOWER_6F_MAX_POTION
	const EVENT_TIN_TOWER_9F_HP_UP
	const EVENT_GAVE_PATRON_ITEM; unused from here 
