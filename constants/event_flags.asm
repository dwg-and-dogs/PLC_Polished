...
; Kanto itemballs
	...
	const EVENT_ROOF_CELEBI ; unused 
	...
	const EVENT_KC4_20
	const EVENT_KC4_10
; Kanto people, UNUSED most of them 
	...
	const EVENT_LAIR_HERBBALL ; unused from here 
...
; New to Crystal
	const EVENT_LAKE_URSALUNA_POSTGAME ; unused from here 
