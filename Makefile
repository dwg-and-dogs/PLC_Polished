...
ifeq ($(filter normalmode,$(MAKECMDGOALS)),normalmode)
RGBASM_FLAGS += -DNORMALMODE
endif
...
.SUFFIXES:
.PHONY: clean tidy crystal faithful nortc debug normalmode monochrome freespace tools bsp
.SECONDEXPANSION:
.PRECIOUS: %.2bpp %.1bpp
.SECONDARY:
