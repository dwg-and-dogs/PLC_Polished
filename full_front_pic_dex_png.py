...
# File path
file_path = 'data/pokemon/big_pic_pointers_022026.asm' # full list of 	dba	CyndaquilFrontpic, etc 
...
def create_pokemon_grid(pokemon_names, grid_size=(12, 24), cell_size=56, border_width=2):
    ...
    output_path = "screenshots/front_images_022026.png"
...
# Main execution
file_path = "data/pokemon/big_pic_pointers_022026.asm"
