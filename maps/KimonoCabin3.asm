KimonoCabin3_MapScriptHeader: ; fix the warps, then reduce the boulders, then write the stonetable, then ready to play it 
	...
	object_event  0, 22, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, UMBREON, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, KimonoCabin3BoulderResetScript, -1 
	object_event  6, 17, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, UMBREON, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, KimonoCabin3BoulderResetScript, -1 
