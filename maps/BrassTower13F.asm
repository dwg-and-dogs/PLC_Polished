BrassTower13F_MapScriptHeader: 
	...
	def_warp_events
	warp_event 3, 1, BRASS_TOWER_12F, 3 ; checked 
	warp_event 11, 1, BRASS_TOWER_12F, 4 ; checked 
	warp_event 2, 15, BRASS_TOWER_15F, 3 ; checked 
	warp_event 10,15, BRASS_TOWER_16F, 3 ; checked 
	...
	pokemon_event  10,  5, MISDREAVUS, -1, -1, PAL_NPC_PURPLE, BrassTowerGuardText, EVENT_BRASS_TOWER_LEFT_GUARD
	pokemon_event  2, 12, MISDREAVUS, -1, -1, PAL_NPC_PURPLE, BrassTowerGuardText, EVENT_BRASS_TOWER_LEFT_GUARD
