UnionCaveB2F_MapScriptHeader:
	...
	object_event 15, 28, SPRITE_HIKER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 1, Ruin_maniacPetry2Script, EVENT_BEAT_RUIN_MANIAC_GLYN; 'PETRY'
