IlexForest_MapScriptHeader:
	...
	bg_event 20,  9, BGEVENT_ITEM + SILVER_LEAF, EVENT_ILEX_FOREST_HIDDEN_SILVER_LEAF_1
	...
	pokemon_event  9, 27, NATU, -1, -1, PAL_NPC_GREEN, IlexForestShuckleText, EVENT_LOGGERS_ILEX_FOREST
