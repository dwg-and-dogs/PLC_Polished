...
;HOLES 
	...
	object_event 12,  9, SPRITE_HISUI_FEMALE, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 3, GenericTrainerHisuiFemaleEsther, EVENT_BEAT_KANNA
...
GenericTrainerHisuiFemaleEsther:
	generictrainer HISUI_FEMALE, ESTHER, EVENT_BEAT_HISUI_FEMALE_ESTHER, .SeenText, .BeatenText
