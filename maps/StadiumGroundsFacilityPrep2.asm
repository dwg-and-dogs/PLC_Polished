StadiumGroundsFacilityPrep2_MapScriptHeader:
	...
	object_event 23, 14, SPRITE_RECEPTIONIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, pokemart, MARTTYPE_STANDARD, MART_BT_4, -1 
	object_event 23, 15, SPRITE_RECEPTIONIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, pokemart, MARTTYPE_STANDARD, MART_BT_5, -1 ; TODO 
	...
	object_event 8, 9, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, ELECTRODE, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptext, FacilityElectrodeText, -1 ; todo 
