LandingTavern_MapScriptHeader:
	...
	object_event 8, 2, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, LandingTavernSailorText2, EVENT_BEAT_KENSEY_PORT
