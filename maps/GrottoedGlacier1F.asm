GrottoedGlacier1F_MapScriptHeader: 
	...
	def_object_events
	object_event  3, 13, SPRITE_HEX_MANIAC, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 1, GenericTrainerHisuiFemaleGrace, EVENT_BEAT_KANNA
