StadiumGrounds_MapScriptHeader:
	...
	object_event 21, 27, SPRITE_TAMER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, StadiumFacilityEntranceNPCText, EVENT_REACHED_CREDITS_ONCE
	object_event 22, 27, SPRITE_TAMER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptext, StadiumFacilityEntranceNPCText, EVENT_REACHED_CREDITS_ONCE
