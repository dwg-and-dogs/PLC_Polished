Gauldenrod_MapScriptHeader: 
	...
	object_event  24, 30, SPRITE_BRIGADER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_GAULDENROD_BRIGADER_CINDY
	; marts etc 
	...
	; quest 
	object_event 14, 13, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, 				OBJECTTYPE_SCRIPT, 0, GauldenrodNPC9Script, EVENT_GAULDENROD_ELDER ; initialized until after bobesh defeated
