Route35_MapScriptHeader:
	...
	object_event 12, 20, SPRITE_ACE_TRAINER_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_GENERICTRAINER, 0, GenericTrainerCooltrainerMNick, -1;
	object_event 11, 20, SPRITE_ACE_TRAINER_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_GENERICTRAINER, 0, GenericTrainerCooltrainerFGwen, -1;
	...
	fruittree_event 10, 27, FRUITTREE_ROUTE_35, TOUGH_LEAVES, PAL_NPC_GREEN
