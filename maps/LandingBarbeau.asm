LandingBarbeau_MapScriptHeader: 
	...
	def_object_events
	object_event 3, 3, SPRITE_KENSEY, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, jumptext, KenseyOfficeKenseyText, EVENT_BEAT_KENSEY_PORT
	...
	pokemon_event  4,  3, VAPOREON, -1, -1, PAL_NPC_SILVER, KenseyVaporeonText, EVENT_BEAT_KENSEY_PORT
