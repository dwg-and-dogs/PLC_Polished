...
.Disappear1:
	...
	pause 20
	showemote EMOTE_HAPPY, GAULDENROD_TOWER_CLEFAIRY_RESET, 20
	disappear GAULDENROD_TOWER_CLEFAIRY_RESET ; might have to use a unique move for each one 
	showemote EMOTE_HAPPY, GAULDENROD_TOWER_CLEFAIRY_R, 20
	disappear GAULDENROD_TOWER_CLEFAIRY_R, teleport_from
	showemote EMOTE_HAPPY, GAULDENROD_TOWER_CLEFAIRY_U, 20
	disappear GAULDENROD_TOWER_CLEFAIRY_U, teleport_from
	showemote EMOTE_HAPPY, GAULDENROD_TOWER_CLEFAIRY_L, 20
	disappear GAULDENROD_TOWER_CLEFAIRY_L, teleport_from
	showemote EMOTE_HAPPY, GAULDENROD_TOWER_CLEFAIRY_D, 20
